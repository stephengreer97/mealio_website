      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '48px 24px', display: 'grid', gridTemplateColumns: '220px 1fr', gap: '48px', alignItems: 'start' }}>
        ...
        <main style={{ minWidth: 0 }}>
          ...
          <section id="creator" style={{ marginBottom: '56px' }}>
            ...
            <p style={p}>
              The Mealio Creator Program allows approved food creators to publish meals to the Discover tab, which is visible to all Mealio users. Popular meals earn a share of Mealio's subscription profit, one third of which is paid out to creators every quarter.
            </p>
            ...
            <p style={p}>
              Each quarter, 1/3 of Mealio's subscription profit goes to the creator pool and is distributed to active Creator Partners. Your share is based entirely on a single rolling 12-month factor:
            </p>
            <ul style={ul}>
          ...
          <section id="faq">
            ...
            {[
              ...
              },
              {
                ...
                a: 'Earnings depend on how often your meals are saved relative to other creators over the last 12 months. 1/3 of Mealio\'s quarterly subscription profit goes to the creator pool, split among all Creator Partners based on each creator\'s share of meal saves in the rolling 12-month window. Your Creator Portal shows your current percentage and a breakdown of the calculation. Payouts are issued quarterly for amounts above $25.',
              },
              {
